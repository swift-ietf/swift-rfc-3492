...
extension PunycodeTests {
    ...
    @Test
    func `Chinese (simplified)`() throws {
    ...
    @Test
    func `Chinese (traditional)`() throws {
    ...
    @Test
    func `Japanese (kanji and hiragana)`() throws {
        let input =
    ...
    @Test
    func `Korean (Hangul syllables)`() throws {
        let input =
    ...
    @Test
    func `Japanese (3 characters)`() throws {
    ...
    @Test
    func `Japanese (symbols and hiragana)`() throws {
    ...
    @Test
    func `Japanese (Hello Another Way)`() throws {
    ...
    @Test
    func `Japanese (Hiragana Maji)`() throws {
    ...
    @Test
    func `Japanese (Pafikaria)`() throws {
    ...
    @Test
    func `Japanese (Sono Speed)`() throws {
    ...
    @Test
    func `Common domain: münchen`() throws {
        let input = "münchen"
